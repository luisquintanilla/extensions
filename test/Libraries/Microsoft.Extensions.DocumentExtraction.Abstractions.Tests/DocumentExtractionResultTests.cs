...
public class DocumentExtractionResultTests
{
    ...
    public void ApiShape_HasSingleStructuredTextAuthorityAndBclImageContent()
    {
        ...
        Assert.NotNull(typeof(DocumentExtractionResult).GetProperty(nameof(DocumentExtractionResult.Usage)));
        Assert.NotNull(typeof(DocumentExtractionPageResult).GetProperty(nameof(DocumentExtractionPageResult.Usage)));
        Assert.NotNull(typeof(DocumentExtractionPageResult).GetProperty(nameof(DocumentExtractionPageResult.PagesProcessed)));
