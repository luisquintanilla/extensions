...
public sealed class DocumentTable : DocumentNode
{
    ...
    internal override IEnumerable<DocumentNode> GetNestedNodes() => Cells;
    ...
    private void ValidateCells()
    {
        for (int cellIndex = 0; cellIndex < Cells.Count; cellIndex++)
        {
            ...
            for (int previousIndex = 0; previousIndex < cellIndex; previousIndex++)
            {
                ...
                bool rowsOverlap = cell.RowIndex < previous.RowIndex + previous.RowSpan &&
                    previous.RowIndex < cell.RowIndex + cell.RowSpan;
                bool columnsOverlap = cell.ColumnIndex < previous.ColumnIndex + previous.ColumnSpan &&
