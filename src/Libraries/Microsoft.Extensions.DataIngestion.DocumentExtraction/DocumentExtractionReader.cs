...
/// <summary>
/// Reads documents by using an <see cref="IDocumentExtractionClient"/> and explicitly maps the
/// normalized extraction output into an <see cref="IngestionDocument"/>.
/// </summary>
public sealed class DocumentExtractionReader : IngestionDocumentReader
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        DocumentExtractionResult result = await _client
            .ExtractAsync(source, mediaType, _extractionOptions?.Clone(), cancellationToken)
