...
#pragma warning restore IDE1006 // Naming Styles
    ...
    /// <summary>
    /// Gets a value indicating whether <see cref="Text"/> is literal source content rather than a
    /// text projection of explicit Markdown.
    /// </summary>
...
public sealed class IngestionDocumentParagraph : IngestionDocumentElement
{
    ...
    /// <summary>
    /// Creates a paragraph from literal text.
    /// </summary>
...
public sealed class IngestionDocumentHeader : IngestionDocumentElement
{
    ...
    /// <summary>
    /// Creates a header from literal text.
    /// </summary>
...
public sealed class IngestionDocumentCodeBlock : IngestionDocumentElement
{
    ...
    /// <inheritdoc/>
    public override string GetMarkdown()
        => MarkdownProjection.CreateCodeFence(Text!);
}
...
public sealed class IngestionDocumentTableCell
{
    ...
    /// <param name="kind">The source cell kind, such as a row or column header.</param>
    ...
    /// <summary>
    /// Gets the nested cell content in reading order.
    /// </summary>
    ...
    /// <summary>
    /// Gets the source cell kind, such as a row or column header.
    /// </summary>
...
#pragma warning disable S3967 // Multidimensional arrays should not be used
    ...
    /// </summary>
    /// <param name="rowCount">The table row count.</param>
    /// <param name="columnCount">The table column count.</param>
    ...
    /// <summary>
    /// Gets the explicitly positioned cells, including their row and column spans.
    /// </summary>
    /// <remarks>
    /// This value is <see langword="null"/> for tables created with the legacy Markdown-and-grid constructor.
    /// </remarks>
...
public sealed class IngestionDocumentImage : IngestionDocumentElement
{
    ...
    /// <summary>
    /// Creates an image from binary content.
    /// </summary>
    ...
    public override string GetMarkdown()
    {
        ...
        string description = AlternativeText ?? Text ?? string.Empty;
        return Source is not null
            ? $"![{MarkdownProjection.EscapeImageAlternativeText(description)}]({Source.OriginalString})"
            : MarkdownProjection.EscapeLiteral(description);
    }
}
